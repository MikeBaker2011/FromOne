  ...
  if (settingsMode === 'simple') {
    return (
      ...
      <BackToDashboardButton />
        ...
        <style jsx global>{`
          /* Full responsive sweep for the simple Settings page */
          .settings-simple-business-page {
            width: 100% !important;
            min-width: 0 !important;
          ...
          .settings-simple-business-page *,
          .settings-simple-business-page *::before,
          .settings-simple-business-page *::after {
            box-sizing: border-box !important;
          }

          .settings-simple-business-page .container,
          .settings-simple-business-page .settings-simple-shell,
          .settings-simple-business-page .settings-simple-content,
          .settings-simple-business-page .settings-simple-card,
          .settings-simple-business-page section,
          .settings-simple-business-page form,
          .settings-simple-business-page article,
          .settings-simple-business-page div {
            min-width: 0;
          }
          ...
          .settings-simple-business-page .settings-simple-card,
          .settings-simple-business-page .settings-panel,
          .settings-simple-business-page .settings-smilez-booking-card {
            width: 100% !important;
            min-width: 0 !important;
            border-radius: 20px !important;
          }

          .settings-simple-business-page input,
          .settings-simple-business-page select,
          .settings-simple-business-page textarea,
          .settings-simple-business-page button {
          ...
          .settings-simple-business-page textarea {
            ...
            box-sizing: border-box !important;
            border: 1px solid rgba(7, 27, 73, 0.13) !important;
            border-radius: 12px !important;
            background-color: #ffffff !important;
            color: #071b49 !important;
            font: inherit !important;
          ...
          .settings-simple-business-page input:focus,
          .settings-simple-business-page select:focus,
          .settings-simple-business-page textarea:focus {
            border-color: #f72585 !important;
            box-shadow: 0 0 0 4px rgba(247, 37, 133, 0.10) !important;
          }

          .settings-simple-business-page label {
            min-width: 0 !important;
          }

          .settings-simple-business-page .settings-simple-grid,
          .settings-simple-business-page .settings-field-grid,
          .settings-simple-business-page .settings-business-grid,
          .settings-simple-business-page .settings-profile-grid {
            display: grid !important;
            grid-template-columns: repeat(2, minmax(0, 1fr)) !important;
            gap: 14px !important;
          }

          .settings-simple-business-page .settings-booking-tabs {
            width: 100% !important;
            display: grid !important;
          ...
          .settings-simple-business-page .settings-booking-tabs button {
            width: 100% !important;
            min-width: 0 !important;
          ...
          .settings-simple-business-page .settings-smilez-day-cards {
            width: 100% !important;
            display: grid !important;
          ...
          .settings-simple-business-page .settings-smilez-capacity-card,
          .settings-simple-business-page .booking-blocked-panel-v2 {
            width: 100% !important;
            min-width: 0 !important;
          ...
          .settings-simple-business-page .settings-smilez-capacity-grid {
            display: grid !important;
            grid-template-columns: repeat(auto-fit, minmax(190px, 1fr)) !important;
            gap: 12px !important;
          }

          .settings-simple-business-page .booking-blocked-form-v2 {
            width: 100% !important;
            min-width: 0 !important;
            display: grid !important;
            grid-template-columns:
              ...
              minmax(220px, 1.2fr)
              minmax(135px, 0.7fr)
              minmax(135px, 0.7fr) !important;
            gap: 12px !important;
            align-items: end !important;
          }

          .settings-simple-business-page .booking-blocked-form-v2 label,
          .settings-simple-business-page .booking-blocked-form-v2 label.is-wide {
            min-width: 0 !important;
            display: grid !important;
            grid-column: auto !important;
            gap: 7px !important;
          ...
          .settings-simple-business-page .booking-blocked-quick-v2 {
            display: flex !important;
            flex-wrap: wrap !important;
            gap: 8px !important;
          }

          .settings-simple-business-page .booking-blocked-quick-v2 button {
          ...
          .settings-simple-business-page .booking-blocked-form-v2 > button,
          .settings-simple-business-page .settings-primary-button,
          .settings-simple-business-page button[type="submit"] {
            min-height: 46px !important;
            border-radius: 12px !important;
          }

          .settings-simple-business-page img {
            max-width: 100% !important;
            height: auto !important;
          }

          .settings-simple-business-page h1 {
            font-size: clamp(2rem, 6vw, 3.7rem) !important;
            line-height: 0.98 !important;
          }

          .settings-simple-business-page h2 {
            font-size: clamp(1.35rem, 3vw, 2rem) !important;
          }

          .settings-simple-business-page p,
          .settings-simple-business-page small,
          .settings-simple-business-page span,
          .settings-simple-business-page label {
  ...
  return (
    <main className="fromone-posts-page fromone-settings-page settings-create-style-page" data-settings-page="create-style-v1">
      ...
      <style jsx global>{`
        ...
        .fromone-settings-page .booking-blocked-list-v2 article {
          min-width: 0 !important;
        }
        ...
        @media (max-width: 720px) {
          ...
          .fromone-settings-page .booking-blocked-list-v2 article > button {
            width: 100% !important;
          }
        }
